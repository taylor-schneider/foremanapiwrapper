...
class Test_ApiStateEnforcer_11_link_pxelinux_with_os(Test_ApiStateEnforcer):

    def __init__(self, *args, **kwargs):
        super(Test_ApiStateEnforcer_11_link_pxelinux_with_os, self).__init__(*args, **kwargs)
    ...
    def _create_provisioning_template(api_state_enforcer, operatingsystem_id):
        ...
        minimal_record = Test_ApiStateEnforcer_11_link_pxelinux_with_os._minimal_record(operatingsystem_id)
