...
from tests.ForemanApiWrapper.ApiStateEnforcer.Test_ApiStateEnforcer_15_host import Test_ApiStateEnforcer_15_host
import logging
...
class Test_ApiStateEnforcer_16_host_parameters(Test_ApiStateEnforcer):

    def __init__(self, *args, **kwargs):
        super(Test_ApiStateEnforcer_16_host_parameters, self).__init__(*args, **kwargs)

    @staticmethod
    def _minimal_record(host_id):
    ...
    @staticmethod
    def _create_parameter(api_state_enforcer, host_id):
        desired_state = "present"
        minimal_record = Test_ApiStateEnforcer_16_host_parameters._minimal_record(host_id)
    ...
    def test__operatingsystem__exists(self):
        ...
        host_id = modification_receipt.actual_record["host"]["id"]
        Test_ApiStateEnforcer_16_host_parameters._create_parameter(self.api_state_enforcer, host_id)
        # Ensure State
        desired_state = "present"
        minimal_record = Test_ApiStateEnforcer_16_host_parameters._minimal_record(host_id)
