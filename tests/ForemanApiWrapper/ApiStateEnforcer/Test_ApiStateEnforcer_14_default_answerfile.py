...
class Test_ApiStateEnforcer_14_default_answerfile(Test_ApiStateEnforcer):

    def __init__(self, *args, **kwargs):
        super(Test_ApiStateEnforcer_14_default_answerfile, self).__init__(*args, **kwargs)

    @staticmethod
    def _minimal_record(operatingsystem_record, answerfile_id):
        ...
        record = {
            ...
            "os_default_template": {
                ...
                "provisioning_template_id": answerfile_id,
                "template_kind_id": 5
            }
        }
    ...
    @staticmethod
    def _create_os_default_template(api_state_enforcer, operatingsystem_record, answerfile_id):
        desired_state = "present"
        minimal_record = Test_ApiStateEnforcer_14_default_answerfile._minimal_record(operatingsystem_record, answerfile_id)
