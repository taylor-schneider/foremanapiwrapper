...
class Test_ApiStateEnforcer_12_link_answerfile_with_os(Test_ApiStateEnforcer):

    def __init__(self, *args, **kwargs):
        super(Test_ApiStateEnforcer_12_link_answerfile_with_os, self).__init__(*args, **kwargs)
    ...
    @staticmethod
    def _create_provisioning_template(api_state_enforcer, operatingsystem_id):
        desired_state = "present"
        minimal_record = Test_ApiStateEnforcer_12_link_answerfile_with_os._minimal_record(operatingsystem_id)
