...
class Test_ApiStateEnforcer_8_pxelinux_provisioning_template(Test_ApiStateEnforcer):

    def __init__(self, *args, **kwargs):
        super(Test_ApiStateEnforcer_8_pxelinux_provisioning_template, self).__init__(*args, **kwargs)
    ...
    @staticmethod
    def _create_pxelinux_provisioning_template(api_state_enforcer, operatingsystem_id):
    ...
    def test__pxelinux_provisioning_template__create(self):
        self.fail("Not implemented")

    def test__pxelinux_provisioning_template_exists(self):
        # Create prereqs
    ...
    def test__pxelinux_provisioning_template__update(self):
        self.fail("Not implemented")

    def test__pxelinux_provisioning_template__delete(self):
        self.fail("Not implemented")